...
\section{Processi organizzativi}
	...
	\subsection{Procedure}
			...
			\begin{enumerate}
				\item cerare un nuovo task impostando i parametri desiderati;
				\item selezionare i membri del gruppo a cui associare il nuovo task;
				\item confermare la creazione del nuovo task.
			\end{enumerate}
			Se il ticket invece deve essere associato ad una attività già presente allora la procedura da seguire è la seguente:
			\begin{enumerate}
			...
			\end{enumerate}
			Al termine dell'attività gli assegnatari dovrà ripetere la procedura sopra riportata ed infine selezionare il checkbox indicante il complemento dell'attività. Questo comporterà la chiusura del ticket.

...
\begin{itemize}
	...
	\item è emersa l'idea di estendere alla navigazione la disposizione delle immagini (o simboli identificabili) per aiutare meglio l'utente a seguire il percorso. Si è giunti alla conclusione che ciò sarebbe apprezzato dal committente anche se rimane sempre nel campo del desiderabile. Questa implementazione però comporta la difficoltà di gestire un considerevole numero di immagini.

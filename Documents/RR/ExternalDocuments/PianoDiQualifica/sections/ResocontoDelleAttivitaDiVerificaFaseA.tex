...
si posizionava al livello 1.\\
			...
			Quindi, possiamo affermare di aver raggiunto il livello 2 della scala\g\ CMM\g, perché il processo\g\ di documentazione non possiede ancora la principale caratteristica richiesta dal terzo livello, ovvero la proattività.
...
controllabile. \\
			Anche per quanto riguarda questo processo\g, come per quello di documentazione, siamo in grado di dire che è stato raggiunto il livello 2 nella scala\g\ prevista da CMM\g. Il processo\g\ ha infatti superato l'iniziale stato caotico nel quale si trovava all'inizio della fase\g\ A (grazie, per esempio, all'utilizzo sistematico di script e di procedure). \\

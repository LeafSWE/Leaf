...
All'interno di questa prima fase, secondo quanto riportato dal \pianodiprogettov, sono previsti più momenti in cui viene attivato il processo di verifica. Si è cercato di riportare in questa sezione tutti i risultati che sono stati ottenuti durante questi momenti. Ove fosse necessario, si sono tratte anche delle conclusioni sui risultati ottenuti e su come essi possono essere migliorati.
...
\begin{table}[H]
		...
		\begin{tabular}{l * {2}{c}}
			...
			\midrule
			\pianodiprogettov & 0 &  Negativo \\
			\normediprogettov & 0 & Negativo \\
			\studiodifattibilitav & 0 & Negativo \\
			\analisideirequisitiv & 0 & Negativo \\
			\pianodiqualificav & 0 & Negativo \\
			\glossariov & 0 & Negativo \\
			%\midrule		
			\bottomrule
		\end{tabular}

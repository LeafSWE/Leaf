...
\section{La strategia di gestione della qualità nel dettaglio}
		...
		\subsection{Tecniche di controllo della qualità}
			...
			Il gruppo intende misurare con continuità le caratteristiche di qualità dei vari processi, al fine di poterli migliorare. Per mettere in atto ciò ci si basa su quanto descritto in seguito.
			\begin{itemize}

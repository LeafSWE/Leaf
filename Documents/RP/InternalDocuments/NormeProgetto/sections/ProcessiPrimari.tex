...
\section{Processi primari}
	...
	\subsection{Sviluppo}
		...
		\subsubsection{Progettazione}
			Descrizione di cosa si intenda per progettazione.
		\paragraph{Progettazione architetturale}
			...
			\subparagraph{Diagrammi UML}
				...
				\begin{description}
					\item[diagramma dei componenti] cos'è e a cosa serve;
					\item[diagramma delle attività] cos'è e a cosa serve.
				\end{description}
			\subparagraph{Classificazione dei componenti}
				Come vengono identificati i componenti (es. codice degli UC).
		...
		\subsubsection{Codifica}
			...
			\paragraph{Documentazione}
				...
				\paragraph{Versionamento dei file di codice}
					...
					\begin{center}\textbf{[X].[YY]}\end{center}, dove
					\begin{itemize}
						\item \textbf{X} è un numero intero, incrementale, corrispondente all'ultima versione stabile del codice;
						\item \textbf{YY} è un numero intero, incrementale, corrispondente al numero di modifiche apportate al codice, partendo dall'ultima versione stabile.
					\end{itemize}
 ...
 sulla base delle esigenze che sono emerse durante la stesura dell'\analisideirequisiti .
			...
			\paragraph{Scrittura del codice} 			
 				Indicare lo strumento utilizzato per scrivere codice Java (IDE).

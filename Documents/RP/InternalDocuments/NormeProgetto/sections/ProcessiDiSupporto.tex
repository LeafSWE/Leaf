	...
	\subsubsection{Metriche}
		...
		\paragraph{Procedure}
			 \subparagraph{Calcolo del valore di una metrica con Android Studio}
			 	Alcune metriche per il software scelte dal gruppo necessitano, per il calcolo dei propri valori, di Android Studio e di un suo plugin, chiamato MetricsReloaded.\\
				Di seguito viene mostrata la procedura da seguire in queste situazioni:
				\begin{enumerate}
					\item aprire Android Studio;
					...
					\begin{itemize}
						...
						\item \textit{Average size}: per visualizzare la dimensione media di un modulo in termini di linee di codice.
					\end{itemize}

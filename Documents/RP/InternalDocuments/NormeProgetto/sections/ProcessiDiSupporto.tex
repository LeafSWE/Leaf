...
\subsection{Qualità}
	\subsubsection{Metriche}
			...
			\begin{itemize}
				\item X indica se la metrica si riferisce a prodotti o processi, può assumere i valori:
				\begin{itemize}
					\item PC per indicare i processi;
					\item PR per i prodotti.
				\end{itemize}
				\item Y (opzionale) indica se il termine prodotto si riferisce a documenti o al software e può assumere i seguenti valori:
					\begin{itemize}
						\item D per i documenti;
						\item S per il software.
					\end{itemize}
				\item Z indica il codice univoco della metrica.
			\end{itemize}
...
\newpage
		\paragraph{Procedure}
			...
			\subparagraph{Aggiornamento del repository}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.2, width=\textwidth]{sections/img/proceduraAggiornamentoRepository.png}

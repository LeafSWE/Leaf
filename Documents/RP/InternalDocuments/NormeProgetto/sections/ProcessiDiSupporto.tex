	...
	\subsubsection{Tipologie di documenti}
		...
		\paragraph{Verbali}
			...
			\subparagraph{Nome del verbale}
				...
				\begin{itemize}
					\item \textbf{X} indica il tipo di verbale. Può assumere solo i seguenti valori:
					\begin{itemize}
			...
			Di conseguenza, se ci si vuole riferire ad una determinata decisione presa in una riunione, è sufficiente indicare il verbale e il numero della decisione (es. \textit{RiunioneInterna2016-02-01, decisione 3}).

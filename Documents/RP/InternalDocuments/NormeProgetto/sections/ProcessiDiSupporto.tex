...
Gli elenchi puntati servono per descrivere elementi di cui non è importante l'ordine espositivo. Essi seguono le seguenti regole:
	...
	\paragraph{Avanzamento di un documento} 
		...
		\begin{figure}[!h]
            \centering
            \includegraphics[scale=0.95, width=\textwidth]{img/proceduraFormalizzazioneDocumento.png}
            \caption{Caso d'uso UCG: Utilizzo generale del prototipo}\label{fig:Procedura formalizzazione di un documento} 
        \end{figure}
		\begin{enumerate}

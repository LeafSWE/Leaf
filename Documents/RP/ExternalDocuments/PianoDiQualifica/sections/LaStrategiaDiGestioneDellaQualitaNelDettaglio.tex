		...
		\subsection{Misure e metriche}\label{MisureMetriche}
			...
			\begin{table}[H]
				...
				\begin{tabular}{l * {2}{c}}
					...
					MPRS7 - Fan-in Fan-out & Manutenibilità\\
					MPRS8 - Cyclomatic Number & Manutenibilità\\
					MPRS9 - Conditional Statement & Manutenibilità\\
					MPRS10 - Adequacy of variable names & Manutenibilità\\
					MPRS11 - Average Module Size & Manutenibilità\\
					MPRS12 - Test Passati Richiesti & Affidabilità\\
					MPRS13 - Failure Avoidance & Affidabilità\\
					MPRS14 - Breakdown Avoidance & Affidabilità\\
					\midrule
				\end{tabular}
			...
			La metrica misura il numero di statement per metodo. Questo ci permette di tenere un grado di manutenibilità del codice accettabile.
			Vengono di seguito riportati i range stabiliti per la metrica appena introdotta:
			\begin{itemize}
			...
			La metrica misura il numero di parametri per metodo. Questo ci permette di tenere un grado di manutenibilità del codice accettabile.
			Vengono di seguito riportati i range stabiliti per la metrica appena introdotta:
			\begin{itemize}
				\item un valore maggiore di 6 è ritenuto negativo;
				\item un valore compreso tra 4 e 6 è ritenuto accettabile;
			...
			\end{itemize}
			\subparagraph{Fan-in Fan-out - MPRS7}\label{MPRS7}
			%TODO
			\begin{itemize}
				\item un valore maggiore 
				\item un valore compreso 
				\item un valore minore
			\end{itemize}
			\subparagraph{Cyclomatic Number - MPRS8}\label{MPRS8}
			...
			\begin{itemize}
				...
				\item un valore minore di 4 è ritenuto ottimale.
			\end{itemize}
			\subparagraph{Conditional Statement - MPRS9}\label{MPRS9}
			...
			\end{itemize}
			\subparagraph{Adequacy of variable names - MPRS10}\label{MPRS10}
			...
			\end{itemize}
			\subparagraph{Average Module Size - MPRS11}\label{MPRS11}
			...
			\end{itemize}
			\subparagraph{Test Passati Richiesti - MPRS12}\label{MPRS12}
			...
			\subparagraph{Failure Avoidance - MPRS13}\label{MPRS13}
			...
			\end{itemize}
			\subparagraph{Breakdown Avoidance - MPRS14}\label{MPRS14}

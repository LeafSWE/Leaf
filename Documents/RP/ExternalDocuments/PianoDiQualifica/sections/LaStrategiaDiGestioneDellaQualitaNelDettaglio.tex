		...
		\subsection{Misure e metriche}\label{MisureMetriche}
			...
			\begin{table}[H]
				...
				\begin{tabular}{l * {2}{c}}
					...
					MPRS8 - Conditional Statement & Manutenibilità\\
					MPRS9 - Adequacy of variable names & Manutenibilità\\
					MPRS10 - Average Module Size & Manutenibilità\\
					MPRS11 - Test Passati Richiesti & Affidabilità\\
					MPRS12 - Failure Avoidance & Affidabilità\\
					MPRS13 - Breakdown Avoidance & Affidabilità\\
					\midrule
				\end{tabular}
			...
			\end{itemize}
			\subparagraph{Adequacy of variable names - MPRS9}\label{MPRS9}
			...
			\end{itemize}
			\subparagraph{Average Module Size - MPRS10}\label{MPRS10}
			...
			\end{itemize}
			\subparagraph{Test Passati Richiesti - MPRS11}\label{MPRS11}
			...
			\subparagraph{Failure Avoidance - MPRS12}\label{MPRS12}
			...
			\end{itemize}
			\subparagraph{Breakdown Avoidance - MPRS13}\label{MPRS13}

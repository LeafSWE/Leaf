...
\section{Visione generale della strategia di gestione della qualità}
	...
	La procedura di denominazione degli obiettivi è spiegata in dettaglio nel documento \normediprogettov.
		...
		\end{itemize}
				...
				\subparagraph{Manutenibilità e Comprensibilità del codice - OBPR3}	
					...
					\begin{description}
						...
						\item [Soglia di accettabilità:] %TODO 
						\item [Soglia di ottimalità:] %TODO
						\item X = %TODO
					\end{description}
					\begin{description}
					...
					\begin{itemize}
						...
						\item \ref{MPRS7} - MPRS7 - Fan-in Fan-out 
						\item \ref{MPRS8} - MPRS8 - Cyclomatic Number
						\item \ref{MPRS9} - MPRS9 - Conditional Statement
						\item \ref{MPRS10} - MPRS10 - Adequacy of variable names
						\item \ref{MPRS11} - MPRS11 - Average Module Size
					\end{itemize}
				...
				Il prodotto deve essere testato in ogni sua parte per garantirne il funzionamento. I test presi in considerazioni sono quelli che testano le funzionalità previste dai requisiti. 
					...
					\end{description}
			    Per una descrizione dettagliata della metrica qui utilizzata e per una maggiore comprensione degli indici di ottimalità e accettabilità presentati si faccia riferimento alla metrica MPRS12 "Test Passati Richiesti" nella sezione \ref{MPRS12}.
				...
				Il prodotto deve essere robusto e non deve interrompere il suo funzionamento in seguito al verificarsi di situazioni anomale. Il prodotto deve essere in grado inoltre di gestire le situazioni di errore.
					...
					\end{description}
					Per una descrizione dettagliata della metrica qui utilizzata e per una maggiore comprensione degli indici di ottimalità e accettabilità presentati si faccia riferimento alla metrica MPRS13 "Failure Avoidance" nella sezione \ref{MPRS13}.
				\subparagraph{Funzionamento senza interruzioni - OBPRS6}
					...
					\end{description}
					Per una descrizione dettagliata della metrica qui utilizzata e per una maggiore comprensione degli indici di ottimalità e accettabilità presentati si faccia riferimento alla metrica MPRS14 "Breakdown Avoidance" nella sezione \ref{MPRS14}.

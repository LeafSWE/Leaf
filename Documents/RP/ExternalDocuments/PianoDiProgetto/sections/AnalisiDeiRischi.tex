...
\label{sec:Problemi personali tra i membri del team}
	...
	\begin{table}[h]
		...
		\begin{tabularx}{\textwidth}{F O O P}
			...
			Analisi di \par Dettaglio & & & \\
			\midrule
			Progettazione Architetturale & Media & Alto & Problemi tra i membri del team\g\ possono causare un rallentamento delle attività. \\
			%\midrule
			%Progettazione \par di Dettaglio \par e codifica \par dei Requisiti \par Obbligatori & & & \\
			\arrayrulecolor{black}
			\bottomrule
...
\label{sec:Mancata comprensione}
	...
	\begin{table}[h]
		...
		\begin{tabularx}{\textwidth}{F O O P}
			...
			Analisi di \par Dettaglio & & & \\
			\midrule
			Progettazione Architetturale & Medio & Medio & Possibili contrasti, nuovi o non riscolti, derivanti dalle fasi precedenti, possono causare ritardi nelle attività\\
			%\midrule
			%Progettazione \par di Dettaglio \par e codifica \par dei Requisiti \par Obbligatori & & & \\
			\arrayrulecolor{black}
			\bottomrule

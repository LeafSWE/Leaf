...
\label{sec:Tecnologie adottate sconosciute}
	...
	\paragraph*{Riscontro effettivo:} 
		\begin{description}
			...
			\item[Fase PA - Progettazione Architetturale] il rischio non si è presentato poichè in questa fase è solo iniziato lo studio id tecnologie quali Android\g\ e delle librerie per utilizzare i beacon\g.
		\end{description}

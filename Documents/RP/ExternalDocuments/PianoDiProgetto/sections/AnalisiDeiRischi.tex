...
\section{Analisi dei rischi}
	...
	Ogni rischio identificato avrà le seguenti caratteristiche: 
		...
		\end{itemize}	
	Ogni rischio verrà monitorato nel tempo e ne verrà indicato l'effettivo riscontro.
    A seguire una tabella riassuntiva con tutti i rischi individuati, mentre nelle prossime sezioni sarà disponibile una descrizione dettagliata per ogni rischio.

...
\begin{itemize}
\item \textbf{Attori}: utente;
\item \textbf{Descrizione}: l'utente deve poter scegliere di ricevere indicazioni sonore che lo guidino alla destinazione scelta. Questo indicazioni consisteno nell'emissione di un suono monotono continuo qundo l'utente segue il percorso previsto, mentre, quando si allontanerà dal percorso previsto, la cui frequenza del suono varierà. Questo tipo di indicazioni è pensato per agevolare la navigazione di utenti che presentano disabilità visive; 
